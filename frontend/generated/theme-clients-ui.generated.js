...
import stylesCss from 'themes/clients-ui/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_clients-ui_componentCss']) {
    
    document['_vaadintheme_clients-ui_componentCss'] = true;
  }
